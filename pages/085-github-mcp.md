...
GitHub MCP의 쓰기 작업은 팀 기록에 바로 남습니다. 다음 작업은 초안과 승인 단계를 분리하세요.

- PR 생성
- PR 리뷰 코멘트 게시
- issue 댓글 작성
- issue 상태 변경
- label, milestone, assignee 변경
- release와 tag 생성

승인 전에는 “게시될 정확한 문장”, “대상 issue/PR 번호”, “변경되는 상태”를 먼저 보여주게 합니다.
...
- [ ] 게시 전 정확한 댓글/리뷰 내용을 확인한다.
- [ ] release와 tag 작업은 별도 승인 절차를 둔다.
